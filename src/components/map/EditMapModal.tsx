...
import { groupMapsByDepartment, getDepartmentLabel } from '../../utils/mapTransformers.ts';
...
const AddMapModal: React.FC<EditMapModalProps> = ({ 
  isOpen, 
  onClose, 
  maps 
}) => {
      ...
      <div className="bg-white rounded-lg shadow-xl p-6 flex flex-col max-w-[60%] w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 pt-2">
            ...
            >
              {createMapMutation.isPending ? 'Actualizando...' : 'Actualizar'}
            </button>
          </div>
        </form>
      </div>
